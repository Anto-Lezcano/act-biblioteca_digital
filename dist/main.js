...
// Crea materiales
const libro1 = new Libro(1, "El Señor de los Anillos", "J.R.R. Tolkien", 1200, "Fantasía");
const libro2 = new Libro(2, "La Casa de los Espiritus", "Marcela Perez", 500);
const revista1 = new Revista(3, "Ciencia y Tecnologia", "Jose Perez, Matilda Ruiz", 202);
// Crea usuario
